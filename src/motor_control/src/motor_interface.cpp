...
namespace motor_control
{
    ...
    {}
    return_type MotorControl::configure(const hardware_interface::HardwareInfo &info)
    {
        if(configure_default(info) !=return_type::OK)
        {return return_type::ERROR;}
        RCLCPP_INFO(rclcpp::get_logger("configuring.."),": initialising..");
   ...
   //return_type MotorControl::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
   /*
       {
    ...
    return_type MotorControl::start()
    {
    ...
    hardware_interface::return_type MotorControl::read()
    {
    ...
    hardware_interface::return_type MotorControl::write()
    {
