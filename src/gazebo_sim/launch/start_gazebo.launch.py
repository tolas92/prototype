...
def generate_launch_description():
    ...
    description_package_name = "prototype"
    ...
    #pkg_prototype=get_package_share_directory('prototype')
    #prototype_models_path=os.path.join(pkg_prototype,'meshes')
    #gazebo_models_path += ':'+ prototype_models_path
