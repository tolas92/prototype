/***************************************************************
  ...
  void setMotorSpeed(int i, double spd) {
    ...
    if (i == LEFT) { 
      ...
      if      (reverse == 0) { analogWrite(RIGHT_MOTOR_FORWARD, 0); analogWrite(RIGHT_MOTOR_BACKWARD, 0); }
      else if (reverse == 1) { analogWrite(RIGHT_MOTOR_BACKWARD, 0); analogWrite(RIGHT_MOTOR_FORWARD, 0); }
    }
  }
