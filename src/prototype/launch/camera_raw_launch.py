            ...
            parameters=[
                {
                    ...
                    'gscam_config': 'v4l2src device=/dev/video0 io-mode=4 isp-mode=2A ! videoconvert ! video/x-raw,format=NV12,width=640,height=480 ! v4l2-ctl -d /dev/video0 -c gain=4 !  v4l2-ctl -d /dev/video0 -c exposure=4  ',
                     #'gscam_config': 'gst-launch-1.0 rkv4l2src device=/dev/video0 io-mode=4 isp-mode=2A ! videoconvert ! video/x-raw,format=NV12,width=1920,height=1080 ! jpegenc ! multifilesink location=%d.jpg',
